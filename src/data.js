...
export const projects = [
    ...
    },
    {
        ...
        title: "SwoleMates",
        description: "'SwoleMates' is a full stack, ReactJS-based app designed to give users a place to keep track of their diet, workouts, and also find friends with similar goals."
    },
    {
        id: 4,
        img: WeatherAPI,
